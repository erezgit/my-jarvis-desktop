...
if [ -f "/Users/erezfern/Workspace/jarvis/tools/config/.env" ]; then
  source "/Users/erezfern/Workspace/jarvis/tools/config/.env"
fi
...
FORMAT="mp3"
SPEED="1.0"
OUTPUT_DIR="/Users/erezfern/Workspace/jarvis/spaces/my-jarvis-desktop/projects/my-jarvis-desktop/tools/voice"
MAX_LENGTH="1000"
...
# Check for desktop mode environment variable
if [ "$JARVIS_DESKTOP_MODE" = "true" ]; then
  AUTO_PLAY="false"
  echo "Desktop mode detected - auto-play disabled"
fi
...
# Build the command
CMD="python3 /Users/erezfern/Workspace/jarvis/tools/src/cli/auto_jarvis_voice.py"
...
if [ -z "$OPENAI_API_KEY" ]; then
  ENV_FILE="/Users/erezfern/Workspace/jarvis/tools/config/.env"
